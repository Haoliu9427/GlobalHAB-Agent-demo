...
页面包含风险研判、真实事件回放、生物响应沙盘、科学解释、探索验证和数据复核六个工作区。真实模块包含南澳大利亚2025复杂Karenia事件的115条qPCR样本，以及挪威沿岸2006–2019年的5,919条有毒藻与环境监测记录。v3.8加入119参数轻量TCN容量敏感性检查且保持24项候选和8步Agent探索不变；v3.9将情景地图扩展至12个全球代表性生产区，并把网箱鱼沙盘改为海区、对象、参数和结果联动。
